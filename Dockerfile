...
FROM ghcr.io/raetro/quartus:base as install
...
ADD ${INTEL_CDN}/13.0sp1/232/ib_installers/max_web-13.0.1.232.qdz .
...
FROM ghcr.io/raetro/quartus:base
...
# Metadata
LABEL \
    org.opencontainers.image.vendor="luisleee"                                       \
    org.opencontainers.image.title="quartus13-max7000"                               \
    org.opencontainers.image.description="Intel Quartus II Synthesis Engine with MAX7000 support" \
    org.opencontainers.image.authors="luisleee"                                      \
    org.opencontainers.image.url="https://github.com/luisleee/quartus13-max7000"     \
    org.opencontainers.image.source="https://github.com/luisleee/quartus13-max7000.git" \
